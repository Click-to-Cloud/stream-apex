...
var lXlIB = function (_Component) {
  _inherits(lXlIB, _Component);

  function lXlIB() {
    _classCallCheck(this, lXlIB);

    return _possibleConstructorReturn(this, (lXlIB.__proto__ || Object.getPrototypeOf(lXlIB)).apply(this, arguments));
  }
...
_metalSoy2.default.register(lXlIB, _step_2Soy2.default);

exports.default = lXlIB;
...
exports.templates = exports.lXlIB = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace lXlIB.
   * @public
   */

  goog.module('lXlIB.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param748 = function param748() {
      ie_open('h2');
      ...
      ie_close('p');
      ie_open('p');
      itext('Stream.apex uses Func objects from R.apex, and a Func is actually a custom Apex object that mimics the behavior of a function.');
      ie_close('p');
      ie_open('p');
    ...
    $templateAlias1(soy.$$assignDefaults({ content: param748 }, opt_data), null, opt_ijData);
  }
  exports.render = $render;
  if (goog.DEBUG) {
    $render.soyTemplateName = 'lXlIB.render';
  }
...
_metalSoy2.default.register(lXlIB, templates);
exports.lXlIB = lXlIB;
